...
const buildArtistPage = function(artist) {
    return `<div class="container" style="background-color: ${artist.backgroundColor};">
    <div class="grain"></div>
    <div class="image_block" style="background-image: url(${artist.backgroundImage2});">
        <div class="filter" style="background-color: ${artist.boxColor};"></div>
    </div>
    <div class="block">
        <h1 style="color: ${artist.textColor}; border: 25px ${artist.boxBorderColor} ${artist.outerBorderStyle};">${artist.name}</h1>
    </div>
    <div class="about_block">
        <div class="about" style=" background-color: ${artist.boxColor};">
            <h2 style="color: ${artist.textColor}; border: 10px ${artist.backgroundColor} ${artist.outerBorderStyle};">ABOUT</h2>
        </div>
        <div class="info">
            <div class="summary">
                <p style="color: ${artist.textColor};">${artist.about}</p>
            </div>
            <div class="portrait" style="background-image: url(${artist.portraitImage});"></div>
            <div class="bullet_list">
                <div class="bullet" style="background-color:${artist.boxColor};">
                    <h3 style="color: ${artist.textColor};">${artist.instrument}</h3>
                </div>
                <div class="bullet" style="background-color:${artist.boxColor};">
                    <h3 style="color: ${artist.textColor};">${artist.location}</h3>
                </div>
                <div class="bullet" style="background-color:${artist.boxColor};">
                    <h3 style="color: ${artist.textColor};">${artist.socialMedia}</h3>
                </div>
                <div class="bullet" style="background-color:${artist.boxColor};">
                    <h3 style="color: ${artist.textColor};">${artist.website}</h3>
                </div>
            </div>
        </div>
    </div>
...
console.log(artistId);
    const artistPage = buildArtistPage(artists[artistId])
    body.innerHTML += artistPage;
};
